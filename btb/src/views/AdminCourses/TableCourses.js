...
export function TableCourses ({courses, onDeleteCourse}) {
    ...
    const handleDelete = async () => {
        try {
            ...
            toast.error('Falha ao deletar a aula. Tente novamente.')
        }
        hideModal()
    }
    return (
    ...
    <Modal  show={courseToDelete} onHide={hideModal}>
        ...
        <Modal.Body>Ao clicar em confirmar o curso <strong>{courseToDelete?.name}</strong> será excluido, Deseja realmente remover o curso?</Modal.Body>
        <Modal.Footer>
